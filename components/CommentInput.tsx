...
export default function CommentInputComponent({ videoID, onCommentAdded }: { videoID: number; onCommentAdded?: () => void }) {
    ...
    const handlePost = async () => {
        ...
        try {
            ...
            const response = await fetch("http://10.0.2.2:7200/push-comment", {
                ...
                body: `parentVideoID=${videoID}&commentText=${encodeURIComponent(text)}`,
            });
