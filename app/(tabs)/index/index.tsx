import { Text, View, Image, ActivityIndicator, FlatList, TouchableOpacity, ScrollView, Animated, Dimensions } from "react-native";
...
export default function Index() {
  ...
  const [selectedTag, setSelectedTag] = useState('Videos');
